...
from .base import BaseGovernanceModel, BaseSecurable, Tag, DEFAULT_SECURABLE_OWNER, get_current_environment
from .enums import SecurableType, PrivilegeType, TableType, ALL_PRIVILEGES_EXPANSION
...
class Table(BaseSecurable):
    ...
    def to_sdk_create_params(self) -> Dict[str, Any]:
        ...
        from databricks.sdk.service.catalog import ColumnInfo as SDKColumnInfo, ColumnTypeName, DataSourceFormat
