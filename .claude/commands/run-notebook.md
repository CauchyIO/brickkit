...
The argument is the notebook path relative to the repo root (e.g. `examples/01_quickstart/basic_catalog.py`).
...
Example: `examples/01_quickstart/basic_catalog.py` → resource key `basic_catalog_job`.
